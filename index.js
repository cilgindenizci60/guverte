...
const STUDENT_NOTES = [
  ...
  {head:"FORMULLER - STABILITE", body:"<b>Heeling moment = w x d</b><br>Burada <b>w</b> kaydiran / yatiran agirlik, <b>d</b> ise agirligin merkez hattindan yatirma mesafesidir.<br><b>Ton-metre</b> cinsinden dusunulur.<br><b>tan(theta) = heeling moment / (displacement x GM)</b><br>Trim change = trimming moment / MCTC<br>Corrected GM = GM - FSC/displacement veya GM - FSC (metre cinsinden verilmisse)<br>Shift of G formu: GG1 = (w x d) / Delta<br>FWA mantigi: tatli suya girince draft artar; yogunluk dusunce gemi daha fazla batar<br><br><b>Ornek 1:</b> 12 ton agirlik 5 m iskeleye kayarsa heeling moment = 12 x 5 = 60 ton-metre olur.<br><b>Ornek 2:</b> 20 ton yuk 4 m kayar, deplasman 8000 ton ve GM 1.0 m ise tan(theta) = 80 / 8000 = 0.01, yani yatma acisi yaklasik 0.57 derece olur.", tip:"Stabilite rakam degil, geminin davranisidir."},
